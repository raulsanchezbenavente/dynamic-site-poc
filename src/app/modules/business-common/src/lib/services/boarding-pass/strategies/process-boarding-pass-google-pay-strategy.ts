...
export class ProcessBoardingPassGooglePayService extends BoardingPassBaseStrategy implements IProcessBoardingPass {
  public readonly type = BoardingPassFormatType.GOOGLE_PAY;
