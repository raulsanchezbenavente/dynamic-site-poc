...
export class DropdownModalKeyEventStrategy extends BaseModalKeyEventStrategy implements IModalKeyEventStrategy {
  public type = EnumModalKeyEventType.DROPDOWN;
  ...
  public setFocusableElements(config: ModalKeyEventStrategyConfigModel): void {
    ...
    if (config.disableAutoFocus) return;
