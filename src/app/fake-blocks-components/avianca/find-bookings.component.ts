...
@Component({
      ...
      <article class="ut-card" *ngFor="let t of trips(); trackBy: trackByTrip">
        ...
        <div class="ut-mid">
          ...
          <div class="ut-line">
            ...
            <div class="ut-dots" aria-hidden="true">
        ...
        <div class="ut-sep" aria-hidden="true"></div>
  ...
  styles: [`
    ...
    @media (max-width: 900px){
      ...
      .ut-time--right{ text-align:left; }
      .ut-line{ align-items:flex-start; }
      .ut-dots{ width: 100%; }
      .ut-cta{ justify-content:flex-start; }
      .ut-btn{ min-width: 220px; }
    }
  `],
})
export class FindBookingsComponent {
  ...
  trackByTrip(_: number, t: LmTripCard) {
