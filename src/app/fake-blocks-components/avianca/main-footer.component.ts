...
@Component({
  ...
  template: `
    <footer class="ft-wrap" role="contentinfo">
      <div class="ft-inner">
        <div class="ft-top">
          <div class="ft-brand" aria-label="Avianca">
            <span class="ft-logo">avianca</span>
            <svg class="ft-mark" viewBox="0 0 64 32" aria-hidden="true">
              <path
          ...
          <div class="ft-follow">
            ...
            <div class="ft-social" aria-label="Social links">
              ...
              <a class="ft-social-btn" href="#" aria-label="Instagram" (click)="$event.preventDefault()">⌁</a>
              <a class="ft-social-btn" href="#" aria-label="LinkedIn" (click)="$event.preventDefault()">in</a>
            </div>
          </div>
        </div>
  ...
  styles: [`
    ...
    @media (max-width: 650px){
      ...
      .ft-follow{ align-items:flex-start; text-align:left; }
      .ft-grid{ grid-template-columns: 1fr; }
      .ft-logo{ font-size: 36px; }
    }
  `],
})
export class MainFooterComponent {
  ...
  trackByTitle(_: number, col: FooterColumn) {
    return col.title;
  }

  trackByLink(_: number, link: FooterLink) {
    return link.label;
  }
}
